...
async function loadAllData() {
  try {
    ...
    // Sort objects and articles by date (newest first)
    allData.objects.sort((a, b) => b.sortDate.localeCompare(a.sortDate));
    allData.articles.sort((a, b) => b.sortDate.localeCompare(a.sortDate));
    
    // Shuffle pictures array for random initial order
    allData.pictures = allData.pictures.sort(() => Math.random() - 0.5);
